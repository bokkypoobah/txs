    ...
    <div class="m-0 p-0">
      <b-card no-body no-header class="border-0">
        ...
        <div class="d-flex flex-wrap m-0 p-0">
          ...
          <div v-if="sync.section == null" class="mt-0 pr-1">
            <b-button size="sm" :disabled="block == null" @click="syncItNew({ sections: ['syncImportExchangeRates'], parameters: Object.keys(settings.selectedAccounts) })" variant="link" v-b-popover.hover.top="'DEV BUTTON 2'"><b-icon-lightning shift-v="+1" font-scale="1.2"></b-icon-lightning></b-button>
          </div>
          <div v-if="sync.section == null" class="mt-0 pr-1">
